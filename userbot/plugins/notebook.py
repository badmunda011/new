...
async def write_page(event):
    ...
    if not os.path.exists(temp_name):
        urllib.request.urlretrieve(
            f"https://github.com/ITS-LEGENDBOT/RESOURCES/raw/master/Resources/Notebook/Images/{page}.jpg",
            temp_name,
        )
    if not os.path.exists(font_name):
        urllib.request.urlretrieve(
            f"https://github.com/ITS-LEGENDBOT/RESOURCES/blob/master/Resources/Notebook/Fonts/{font}.ttf?raw=true",
            font_name,
        )
...
async def notebook_conf(event):
    ...
    urllib.request.urlretrieve(
        f"https://github.com/ITS-LEGENDBOT/RESOURCES/raw/master/Resources/Notebook/Images/{temp_page}.jpg",
        file,
    )
